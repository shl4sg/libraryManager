...
<%@include file="navigation.jsp"%>
	<div class="section">
		<div class="mainbg">
			<div id="maintable">
				<div id="place_left">当前位置：图书借还 &gt; 图书借阅&gt;&gt;&gt;&nbsp;</div>
				<img src="Images/borrow.gif" width="1000px">
				<div id="mainbody">
	<form name="form1" method="post" action="borrow?action=bookborrow">
<table width="100%" border="0" cellpadding="1" cellspacing="0" bordercolor="#FFFFFF" bgcolor="#F8BF73">
          <tr>
...
%>
                <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                  ...
                  <tr>
                    <td><table width="90%" height="21" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="24%" height="37" style="padding-left:7px;padding-top:7px;"><img src="Images/reader_checkbg.jpg" width="142" height="18"></td>
               ...
               <tr>
                 <td height="37" background="Images/borrow_if.gif">&nbsp;添加的依据：
