...
<body>
<div class="openwindowbox" style="padding-top:23px;">
...
系统设置</td>
      ...
      <tr>
        ...
        <td><input name="Button" type="submit" class="btn_grey" style="font-size: 12px;height:24px;" value="保存">
&nbsp;
<input name="Submit2" type="button" class="btn_grey" value="关闭" style="height:24px;font-size: 12px;" onClick="window.close();"></td>
      </tr>
    </table>
	</form>
</div>
