...
<body onLoad="clockon(bgclock)">
	...
	<div class="section">
		<div class="mainbg">
			<div id="maintable">
				<div id="place_left">当前位置：系统查询 &gt; 图书借阅查询&gt;&gt;&gt;&nbsp;</div>
				<div id="mainbody">
					<form name="myform" method="post"
						action="borrow?action=borrowQuery">
						<table width="100%" border="0" cellpadding="0" cellspacing="0"
							...
							<tr>
								...
								<td height="45" bgcolor="#F9D16B"><input name="flag"
							...
							<tr>
								<td height="40" bgcolor="#F9D16B"><input name="flag"
									type="checkbox" class="noborder" value="b"> 借阅时间： 从 <input
									name="sdate" type="text" id="sdate"> 到 <input
									name="edate" type="text" id="edate"> (日期格式为：2017-02-14)</td>
							</tr>
						</table>
					</form>
					<%
